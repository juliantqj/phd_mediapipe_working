...
input_videos_folder = 'test_videos/'
...
start_time_structure = time.localtime(start_time_seconds)
start_time_hours = start_time_structure.tm_hour
start_time_minutes = start_time_structure.tm_min
start_time = f"Start Time: {start_time_hours}:{start_time_minutes}"
...
for video_file_path in video_files:
    ...
    # Rest of your data export and video export paths setup
    ...
    alpha = 0.2  # min confidence level from the person-detection model for the detection to be considered successful
    beta = 0.9  # higher value can increase robustness of the solution, at the expense of a higher latency
    ...
    # Can change this section if you want to output in another location
    dirVID = 'test_videos/export_vid/' + video_file_name + '/'
    # Export path for the coordinates
    dirDAT = 'test_videos/export_dat/' + video_file_name + '/'
    ...
    if export_vid > 1:
        out = cv2.VideoWriter((dirVID + video_file_name + '_Pose_output.mp4'),
                              fourcc, fps, (int(cap.get(3)), int(cap.get(4))))
        out_black = cv2.VideoWriter((dirVID + video_file_name + '_Pose_output_black.mp4'),
                                    fourcc, fps, (int(cap.get(3)), int(cap.get(4))))
    ...
    filePath_temp = (dirDAT + video_file_name + '_Pose_out_dat.csv')
    ...
    with mp_pose.Pose(
        ...
        while cap.isOpened():
            ...
            # results.pose_world_landmarks <-- world coordinates
            # results.pose_landmarks <-- normalised coordinates
            ...
            if export_data > 1:
                if results.pose_world_landmarks:
                    ...
                    for i in range(len(landmark_list_pose)):
                        ...
                        # uncomment the multiplication portion if you want world coordinates
            ...
            if export_data > 1 and one_file_per_frame > 1:
                if results.pose_world_landmarks:
                    ...
                    df.rename(columns={0: 'nose_X', 1: 'left_eye_inner_X', 2: 'left_eye_X', 3: 'left_eye_outer_X',
                                       4: 'right_eye_inner_X', 5: 'right_eye_X', 6: 'right_eye_outer_X',
                                       7: 'left_ear_X', 8: 'right_ear_inner_X',
                                       9: 'mouth_left_X', 10: 'mouth_right_X',
                                       11: 'left_shoulder_X', 12: 'right_shoulder_X',
                                       13: 'left_elbow_X', 14: 'right_elbow_X',
                                       15: 'left_wrist_X', 16: 'right_wrist_X',
                                       17: 'left_pinky_X', 18: 'right_pinky_X',
                                       19: 'left_index_X', 20: 'right_index_X',
                                       21: 'left_thumb_X', 22: 'right_thumb_X',
                                       23: 'left_hip_X', 24: 'right_hip_X',
                                       25: 'left_knee_X', 26: 'right_knee_X',
                                       27: 'left_ankle_X', 28: 'right_ankle_X',
                                       29: 'left_heel_X', 30: 'right_heel_X',
                                       31: 'left_foot_index_X', 32: 'right_foot_index_X',
                                       33: 'nose_Y', 34: 'left_eye_inner_Y', 35: 'left_eye_Y', 36: 'left_eye_outer_Y',
                                       37: 'right_eye_inner_Y', 38: 'right_eye_Y', 39: 'right_eye_outer_Y',
                                       40: 'left_ear_Y', 41: 'right_ear_inner_Y',
                                       42: 'mouth_left_Y', 43: 'mouth_right_Y',
                                       44: 'left_shoulder_Y', 45: 'right_shoulder_Y',
                                       46: 'left_elbow_Y', 47: 'right_elbow_Y',
                                       48: 'left_wrist_Y', 49: 'right_wrist_Y',
                                       50: 'left_pinky_Y', 51: 'right_pinky_Y',
                                       52: 'left_index_Y', 53: 'right_index_Y',
                                       54: 'left_thumb_Y', 55: 'right_thumb_Y',
                                       56: 'left_hip_Y', 57: 'right_hip_Y',
                                       58: 'left_knee_Y', 59: 'right_knee_Y',
                                       60: 'left_ankle_Y', 61: 'right_ankle_Y',
                                       62: 'left_heel_Y', 63: 'right_heel_Y',
                                       64: 'left_foot_index_Y', 65: 'right_foot_index_Y',
                                       66: 'nose_Z', 67: 'left_eye_inner_Z', 68: 'left_eye_Z', 69: 'left_eye_outer_Z',
                                       70: 'right_eye_inner_Z', 71: 'right_eye_Z', 72: 'right_eye_outer_Z',
                                       73: 'left_ear_Z', 74: 'right_ear_inner_Z',
                                       75: 'mouth_left_Z', 76: 'mouth_right_Z',
                                       77: 'left_shoulder_Z', 78: 'right_shoulder_Z',
                                       79: 'left_elbow_Z', 80: 'right_elbow_Z',
                                       81: 'left_wrist_Z', 82: 'right_wrist_Z',
                                       83: 'left_pinky_Z', 84: 'right_pinky_Z',
                                       85: 'left_index_Z', 86: 'right_index_Z',
                                       87: 'left_thumb_Z', 88: 'right_thumb_Z',
                                       89: 'left_hip_Z', 90: 'right_hip_Z',
                                       91: 'left_knee_Z', 92: 'right_knee_Z',
                                       93: 'left_ankle_Z', 94: 'right_ankle_Z',
                                       95: 'left_heel_Z', 96: 'right_heel_Z',
                                       97: 'left_foot_index_Z', 98: 'right_foot_index_Z',
                                       ...
                                       108: 'mouth_left_vis', 109: 'mouth_right_vis',
                                       110: 'left_shoulder_vis', 111: 'right_shoulder_vis',
                                       112: 'left_elbow_vis', 113: 'right_elbow_vis',
                                       114: 'left_wrist_vis', 115: 'right_wrist_vis',
                                       116: 'left_pinky_vis', 117: 'right_pinky_vis',
                                       118: 'left_index_vis', 119: 'right_index_vis',
                                       120: 'left_thumb_vis', 121: 'right_thumb_vis',
                                       122: 'left_hip_vis', 123: 'right_hip_vis',
                                       124: 'left_knee_vis', 125: 'right_knee_vis',
                                       126: 'left_ankle_vis', 127: 'right_ankle_vis',
                                       128: 'left_heel_vis', 129: 'right_heel_vis',
                                       130: 'left_foot_index_vis', 131: 'right_foot_index_vis',
                ...
                df.to_csv((dirDAT + video_file_name + '_Pose_Frame ' + str(int(frame_num)) + '.csv'),
            ...
            if export_data > 1 > one_file_per_frame:
                ...
                temp = pd.read_csv((dirDAT + video_file_name + '_Pose_out_dat.csv'), sep=',', header=None)
                ...
                temp.to_csv((dirDAT + video_file_name + '_Pose_out_dat.csv'), mode='w', sep=',', index=True,
                            header=True)
                temp.to_json((dirDAT + video_file_name + '_Pose_out_dat.json'), index=True)

        # # If data combination is enabled
        # if export_data > 1 and one_file_per_frame > 1:
        #     # Read all csv in this folder
        #     os.chdir('/Users/juliantanquahjian/mediapipe_working/videos/export_dat/' + video_file_name)
        #     extension = 'csv'
        #     all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
        #     # combine all files in the list
        #     # temp = pd.concat([pd.read_csv(f) for f in all_filenames], axis=0)
        #     temp = pd.concat([pd.read_csv(csv_file) for csv_file in all_filenames], axis=0)
        ...
        #     temp.to_csv(("combined/" + video_file_name + '_Pose_out_dat.csv'), mode='w', sep=',', index=True,
        #                 header=True)
        #     temp.to_json(("combined/" + video_file_name + '_Pose_out_dat.json'), index=True)
...
#     # Get the video file name without extension
#     video_file_name = os.path.splitext(os.path.basename(video_file_path))[0]
#     dirDAT = 'videos/export_dat/' + video_file_name + '/'
#
#     if export_data > 1 and one_file_per_frame > 1:
#         for csv_file in dirDAT:
#             # Read all csv in this folder
#             # Remember to change this!!!!! if you want to compile all csv into one
#             os.chdir('/Users/juliantanquahjian/mediapipe_working/videos/export_dat/' + video_file_name)
#             extension = 'csv'
#             all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
#             # combine all files in the list
...
def process_csv(csv_file):
    # Read a single CSV file and process it
    df = pd.read_csv(csv_file)
    df = df.sort_values(by=['frame_num'], axis=0, ascending=True)
    return df
...
if __name__ == "__main__":
    video_files = "test_videos/"  # List of video file paths
    export_data = export_data
    one_file_per_frame = one_file_per_frame

    pool = Pool(processes=4)  # Change the number of processes as needed
    ...
    for video_file_path in video_files:
        ...
        if export_data > 1 and one_file_per_frame > 1:
            os.chdir('/Users/juliantanquahjian/phd_mediapipe_working/test_videos/export_dat/' + video_file_name)
            extension = 'csv'
            all_filenames = [i for i in glob.glob('*.{}'.format(extension))]

            # Use multiprocessing to process CSV files concurrently
            result_dataframes = pool.map(process_csv, all_filenames)

            combined_df = pd.concat(result_dataframes, axis=0)
            combined_df = combined_df.sort_values(by=['frame_num'], axis=0, ascending=True)

            if not os.path.exists("combined/"):
                os.makedirs("combined/")

            combined_df.reset_index(inplace=True)
            combined_df.to_csv(("combined/" + video_file_name + '_Pose_out_dat.csv'), mode='w', sep=',', index=True, header=True)
            combined_df.to_json(("combined/" + video_file_name + '_Pose_out_dat.json'), index=True)
...
end_time_structure = time.localtime(end_time_seconds)
end_time_hours = end_time_structure.tm_hour
end_time_minutes = end_time_structure.tm_min
end_time = f"End Time: {end_time_hours}:{end_time_minutes}"

elapsed_time_seconds = end_time_seconds - start_time_seconds
elapsed_hours = int(elapsed_time_seconds / 3600)
elapsed_minutes = int((elapsed_time_seconds % 3600) / 60)
elapsed_seconds = int(elapsed_time_seconds % 60)
elapsed_time = f"Elapsed Time: {elapsed_hours} hours, {elapsed_minutes} minutes, {elapsed_seconds} seconds"

# Calculate frames per second (FPS)
processing_fps = frame_count / elapsed_time_seconds

# Print the processing speed (FPS)
print(start_time)
print(end_time)
print(elapsed_time)
print("Processing Speed: ", processing_fps, " FPS")
